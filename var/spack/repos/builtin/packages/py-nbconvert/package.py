...
class PyNbconvert(PythonPackage):
    ...
    homepage = "https://github.com/AlexanderRichert-NOAA/nbconvert"
    git = "https://github.com/AlexanderRichert-NOAA/nbconvert"
    pypi = "nbconvert/nbconvert-6.0.1.tar.gz"

    license("BSD-3-Clause")

    version("7.5.0", commit="d7f559f0c59e2f5bfc362f731f612b3764549211", branch="update_hatch_build")
    ...
    def install_css(self):
        ...
        for f in css.keys():
            ...
            mkdirp(dest)
            install(
                join_path(self.stage.source_path, "resource_%s" % f, css[f][1]),
                join_path(dest, f)
            )
